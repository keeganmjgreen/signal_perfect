...
Consider the banded $A$ matrix from the previous subsection. Its zero cells can be removed and its nonzero cells can be shifted into a significantly smaller, non-square matrix of shape $7\times3n$:
